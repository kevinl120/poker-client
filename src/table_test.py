...
def main():
    ...
    tblstr = "PokerTable({'sb': 0.01, 'bb': 0.02, 'players': [Player(1.96, [4204049, 16795671], 0, ['fold', 'check', [0.02, 1.96]]), Player(1.96, [268471337, 134224677], 0,[]), None, Player(2, None, 0, []), None, Player(1.96, [1057803, 98306], 0, [])], 'players_at_table': 4, 'players_in_hand': 3, 'button_pos': 5, 'current_turn':0, 'board': [134236965, 266757, 8406803], 'pot': 0.12000000000000001, 'side_pots': {}, 'total_to_call': 0, 'last_raise_size': 0.02, 'last_raiser': 5})"
